...
window.addEventListener('DOMContentLoaded', () => {
    // Actually check if the table of contents is being displayed, otherwise skip, as the search will result in errors from no elements being present
    if (document.getElementsByClassName("article-toc").length > 0) {
